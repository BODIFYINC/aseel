  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-5 overflow-hidden">
        ...
        <div className="absolute bottom-32 right-20 w-24 h-24 bg-medical-400/15 rounded-full animate-bounce-gentle" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-medical-300/20 rounded-full animate-pulse-scale" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 text-center text-white container-custom px-4">
        <div className="animate-fade-in-up">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="block opacity-0 animate-slide-in-right" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
              مرحبًا بكم في
            </span>
            <span className="block text-medical-300 mt-2 opacity-0 animate-slide-in-left" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
              مصحة أسيل الغد
            </span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-slate-200 max-w-3xl mx-auto leading-relaxed opacity-0 animate-fade-in" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
            نقدم رعاية طبية شاملة على مدار الساعة بأحدث التقنيات وأفضل الخدمات في سبها
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center opacity-0 animate-fade-in" style={{ animationDelay: '1.1s', animationFillMode: 'forwards' }}>
            <Button 
              onClick={scrollToContact}
              className="btn-primary text-lg px-8 py-4 group hover:animate-pulse-scale transition-all duration-300"
            >
            ...
            <a 
              ...
              className="btn-secondary text-lg px-8 py-4 inline-block group hover:animate-glow transition-all duration-300"
            >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center opacity-0 animate-slide-in-right group" style={{ animationDelay: '1.7s', animationFillMode: 'forwards' }}>
            <div className="w-16 h-16 bg-medical-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:animate-bounce-gentle transition-all duration-300 group-hover:bg-medical-400">
          ...
          <div className="text-center opacity-0 animate-slide-in-right group" style={{ animationDelay: '2s', animationFillMode: 'forwards' }}>
            <div className="w-16 h-16 bg-medical-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:animate-bounce-gentle transition-all duration-300 group-hover:bg-medical-400">
              <span className="text-2xl group-hover:scale-110 transition-transform duration-300">🔬</span>
            </div>
